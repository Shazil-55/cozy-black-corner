...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-lg border bg-card text-card-foreground shadow-sm enhanced-card glassmorphism transition-all duration-300 hover:shadow-lg hover:border-purple-200/50 dark:hover:border-purple-700/50",
      className
    )}
    {...props}
  />
